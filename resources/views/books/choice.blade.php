            ...
            <div class="card-deck">
                <div class="card text-center">
                    <a href="{{ action('BookController@create_with_barcode') }}">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-black">バーコード登録</h5>
                            <p class="card-text text-black">[推奨]本の裏表紙のISBNのバーコードを読み取り、登録します。（複数登録可能）</br>
                ...
                <div class="card text-center">
                    <a href="{{ action('BookController@create_with_form') }}">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-black">手入力登録</h5>
                            <p class="card-text text-black">バーコード入力ができない場合にこちらをご利用ください。</p>
                        </div>
                    </a>
                </div>
            </div>
